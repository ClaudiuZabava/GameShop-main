package com.awbd.gameshop.exceptions.handlers;
...
public ModelAndView handleEmailAlreadyUsedException(EmailAlreadyUsedException ex, WebRequest request) {
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(DeletedGameException.class)
    public ModelAndView handleDeletedGameException(DeletedGameException ex, WebRequest request) {
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.getModel().put("exception",ex);
        modelAndView.setViewName("deletedGameException");
        return modelAndView;
    }
