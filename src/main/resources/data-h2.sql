...
insert into users(id, username, email, password, first_name, last_name, enabled, authority_id)
values (3, 'ana12', 'ana@yahoo.com', 'password', 'ana', 'popov', true, 1);

insert into users(id, username, email, password, first_name, last_name, enabled, authority_id)
values (4, 'anda12' ,'anda@yahoo.com', 'password', 'anda', 'popova', true, 1);
...
insert into games(id, is_deleted, name, price, author_id,year_date,volume)
values (1, false, 'game1', 11.25, 1,2000,1);

insert into games(id, is_deleted, name, price, author_id,year_date,volume)
values (2, false, 'game2', 20.33, 2,2000,1);

insert into  game_baskets(id, copies, price, basket_id, game_id)
values (1, 2, 22.5, 2, 1);
...
insert into games_game_categories(game_id, game_categories_id)
values (1, 1);
